...
registerBlockType( 'cgb/block-advanced-alert-block', {
	// Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
	title: __( 'Advanced Alert Block' ), // Block title.
	icon: {
		src:'bell',
		background: '#cce5ff',
		foreground: '#004085',
	 ...
	 */
	edit:  props => {
		// Creates a <p class='wp-block-cgb-block-advanced-alert-block'></p>.
